...
В данном документе собрана техническая спецификация API Яндекс Мессенджера (включая веб-версию и мобильное приложение Телемост `ru.yandex.telemost`), полученная в результате реверс-инжиниринга и анализа сетевого трафика. Клиент **2.173.0** ходит в эти эндпоинты через session cookies + OAuth.
